...
//                   alt="ConnectHub logo with professional blue gradient"
//                 />
//               </div>
//             </div>
...
//               <button
//                 id="auth-btn"
//                 className="px-4 py-2 rounded-full text-sm font-medium gradient-bg bg-blue-500 text-white hover:bg-blue-700 transition-colors"
//                 onClick={() => handleOpenModal()} // Add logic to toggle modal
//               >
//                 Sign In
//               </button>
//             </div>
